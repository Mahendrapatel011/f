    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-100 via-blue-50 to-pink-100 flex items-start justify-center p-4 pt-20 sm:p-6 lg:p-8">
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl overflow-hidden w-full max-w-[700px] flex flex-col md:flex-row">
                ...
                {/* Right Panel - Dark Blue - Forgot Password Form */}
                <div className="flex-1 bg-[#1e3a5f] p-4 sm:p-6 flex flex-col justify-center md:rounded-l-3xl">
                    ...
                    <div className="flex items-center gap-3 mb-4 sm:mb-5">
                        ...
                        <h1 className="text-lg sm:text-xl font-bold text-white">Forgot Password</h1>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="text-center md:text-left">
                            <p className="text-xs sm:text-sm text-gray-300">
                                Enter your registered email or mobile number to receive an OTP for password reset.
                            </p>
                        </div>
                        ...
                        <div>
                            <input
                                ...
                                className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm text-gray-700 placeholder-gray-400"
                            />
                        </div>
